...
class AuthModel(AbstractModel):
    ...
    def create_user(self, username, address, password):
        """
        新規ユーザ作成
        :param username: ユーザ名
        ...
        sql = "INSERT INTO users(username, address, password) VALUE (%s, %s, %s);"
        self.execute(sql, username, address, hashed_password)
